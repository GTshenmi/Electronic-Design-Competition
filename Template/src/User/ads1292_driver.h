#ifndef __ADS1292_DRIVER_H_
#define __ADS1292_DRIVER_H_	 

#define ADS1292_START_PIN    PTB22
#define ADS1292_RESET_PIN    PTB23  
#define ADS1292_DRDY_PIN     PTB21
//#define ADS1292_CLKSEL_PIN   PTB24	

#define ADS1292_START        PTB22_OUT
#define ADS1292_RESET        PTB23_OUT
#define ADS1292_DRDY	     PTA21_OUT	
//#define ADS1292_CLKSEL	     PTB25_OUT	

		//ADS1292R 具有呼吸和导联脱落检测的功能
		//ID
		#define	ADS1292_DEVICE	DEVICE_ID_ADS1292		//注意1292芯片不能使用呼吸相关的功能，会导致数据不正常
		//1		CONFIG1	
		...
		#define	ADS1292_VREF							VREF_242V						//设置内部参考电压
